<template>
    <div>
        <section class="banner banner--style1">
            <div class="banner__bg">
                <div class="banner__bg-element">
                    <img :src="'/assets/images/banner/home1/bg.png'" alt="section-bg-element"
                                        ...
                                        <div class="nav nav--feature flex-column nav-pills" id="feat-pills-tab"
                                            ...
                                            <div class="nav-link" id="feat-pills-three-tab" data-bs-toggle="pill"
                                                ...
                                                <div class="feature__item">
                                                    <div class="feature__item-inner">
                                                        <div class="feature__item-content">
                                                            <h6>Mobile payment is more flexible and easy for all
                                                                investors</h6>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="nav-link" id="feat-pills-four-tab" data-bs-toggle="pill"
                                                ...
                                                <div class="feature__item">
                                                    <div class="feature__item-inner">
                                                        <div class="feature__item-content">
                                                            <h6>all transaction is kept free for the member of pro
                                                                traders</h6>
                                                        </div>
                                                    </div>
                                                </div>
        ...
        <section class="roadmap roadmap--style1 padding-top  padding-bottom bg-color" id="roadmap">
            <div class="container">
                <div class="section-header section-header--max50">
                    <h2 class="mb-15 mt-minus-5">Product <span> roadmap</span></h2>
                    <p>A product roadmap shows the path ahead, helps teams plan, and guides the delivery of the
                        product.</p>
                </div>
                <div class="roadmap__wrapper">
                    <div class="row gy-4 gy-md-0 gx-5">
                            ...
                            <div class="roadmap__item ms-md-4 aos-init aos-animate" data-aos="fade-left"
                                ...
                                <div class="roadmap__item-inner">
                                    <div class="roadmap__item-content">
                                        ...
                                        <p>Project research is the backbone of any successful project. It involves
                                ...
                                <div class="roadmap__item-inner">
                                    <div class="roadmap__item-content">
                                        ...
                                        <p>Hey there! Just wanted to throw out a framing idea for our upcoming project.
                                            ...
                                            big picture and then work our way down to the details. This way we ensure
                                ...
                                <div class="roadmap__item-inner">
                                    <div class="roadmap__item-content">
                                        ...
                                        <p>Hey guys, just wanted to share my design first draft! I went for a minimalist
                                            look with a pop of
                                            color. What do you think? Open to any suggestions or feedback. Can't wait to
                        ...
                        <div class="col-md-6">
                            <div class="roadmap__item roadmap__item--style2 ms-auto me-md-4 aos-init"
                                 data-aos="fade-right"
                                 data-aos-duration="800">
                                <div class="roadmap__item-inner">
                                    <div class="roadmap__item-content">
                                        ...
                                        <p>So after lots of reiterations, and endless tweaking, we finally landed on the
                                            final design. It's
                                            slick, it's modern, and it perfectly captures the essence of what we were
                                            aiming for. We couldn't be
                            ...
                            <div class="roadmap__item ms-md-4 aos-init" data-aos="fade-left" data-aos-duration="800">
                                <div class="roadmap__item-inner">
                                    <div class="roadmap__item-content">
                                        ...
                                        <p>So we're deep in project development here, and things are coming along
                                            nicely. We've got a solid
                                            plan in place and our team is firing on all cylinders. There's still work to
                                            be done, but we're
                            ...
                            <div class="roadmap__item roadmap__item--style2 ms-auto me-md-4 aos-init"
                                ...
                                <div class="roadmap__item-inner">
                                    <div class="roadmap__item-content">
                                        ...
                                        <p>Alright folks, it's time to get this project off the ground! We've been
                                            talking about it for weeks,
                                            and now it's time to launch. We've got all the pieces in place, so let's get
                                            to work and make this
                                            thing happen!</p>
                                    </div>
                                </div>
                                        ...
                                        <div class="pricing__item-middle">
                                            <ul class="pricing__list">
                                                <li class="pricing__list-item"><span><img
                                                    :src="'/assets/images/icon/check.svg'" alt="check"
                                                    class="dark"></span>
                                                ...
                                                <li class="pricing__list-item">
                                                    <span><img :src="'/assets/images/icon/check.svg'" alt="check"
                                                               class="dark"></span>Personal training
                                                </li>
                                            </ul>
                            ...
                            <div class="pricing__item " data-aos="fade-up" data-aos-duration="1000">
                                <div class="pricing__item-inner active">
                                    <div class="pricing__item-content">
                                        ...
                                        <!-- pricing bottom part -->
                                        <div class="pricing__item-bottom">
                                            <a href="signup.html" class="trk-btn trk-btn--outline active">Choose
                                                Plan</a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="section-header d-md-flex align-items-center justify-content-between">
                    ...
                    <div class="section-header__action">
                        <div class="swiper-nav swiper-nav--style1">
                            <button class="swiper-nav__btn blog__slider-prev"><i class="fa-solid fa-angle-left"></i>
                            </button>
                                ...
                                <div class="blog__item blog__item--style2">
                                    <div class="blog__item-inner">
                                        ...
                                        <div class="blog__content">
                                            <div class="blog__meta">
                                                <span
                                                    class="blog__meta-tag blog__meta-tag--style1">Trading market</span>
                                            </div>
                                ...
                                <div class="testimonial__item testimonial__item--style1">
                                    <div class="testimonial__item-inner">
                                        <div class="testimonial__item-content">
                                            <p class="mb-0">
                                                The above testimonial is about Martha Chumo, who taught herself to code
                                                in one summer. This
                                    ...
                                    <div class="testimonial__item-inner">
                                        <div class="testimonial__item-content">
                                            <p class="mb-0">
                                                ...
                                                While the post is scattered with too many product mentions, it takes
                                                full advantage of its real
                                        ...
                                        <div class="accordion__item ">
                                            <div class="accordion__header" id="faq1">
                                                <button class="accordion__button" type="button"
                                                        ...
                                                        data-bs-target="#faqBody1" aria-expanded="false"
                                                        aria-controls="faqBody1">
                                                    <span
                                                        class="accordion__button-content">What does this tool do?</span>
                                            ...
                                            <div id="faqBody1" class="accordion-collapse collapse show"
                                                ...
                                                <div class="accordion__body">
                                                    <p class="mb-15">
                                                        Online trading’s primary advantages are that it allows you to
                                                        manage your trades at your convenience.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="accordion__item ">
                                            ...
                                            <div id="faqBody2" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion__body">
                                                    <p class="mb-15">
                                                        You don’t need to worry, the interface is user-friendly. Anyone
                                                        can use
                                                        it smoothly. Our user manual will help you to solve your
                                                        problem.
                                                    </p>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="accordion__item ">
                                            <div class="accordion__header" id="faq3">
                                                <button class="accordion__button collapsed" type="button"
                                                        data-bs-toggle="collapse"
                                                        data-bs-target="#faqBody3" aria-expanded="false"
                                                        aria-controls="faqBody3">
                                                    <span
                                                        class="accordion__button-content">Is online trading safe?</span>
                                                    <span class="accordion__button-plusicon"></span>
                                                </button>
                                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="accordion__item ">
                                            <div class="accordion__header" id="faq4">
                                                <button class="accordion__button collapsed" type="button"
                                                        data-bs-toggle="collapse"
                                                        data-bs-target="#faqBody4" aria-expanded="false"
                                    ...
                                    <div class="col-12">
                                        <div class="accordion__item ">
                                            <div class="accordion__header" id="faq5">
                                                <button class="accordion__button collapsed" type="button"
                                                        data-bs-toggle="collapse"
                                                        data-bs-target="#faqBody5" aria-expanded="false"
            ...
            <div class="container">
                <div class="cta__wrapper">
                    <div class="cta__newsletter justify-content-center">
                        <div class="cta__newsletter-inner" data-aos="fade-up" data-aos-duration="1000">
                            ...
                            <div class="cta__subscribe">
                                ...
                                <p>Hey! Are you tired of missing out on our updates? Subscribe to our news now and stay
                                    in the loop!</p>
                                <form class="cta-form cta-form--style2 form-subscribe" action="#">
                                    <div class="cta-form__inner d-sm-flex align-items-center">
                                        ...
                                        <button class="trk-btn  trk-btn--large trk-btn--secondary2" type="submit">
                                            Submit
                                        </button>
                                    </div>
                                </form>
                    ...
                    <div class="cta__shape">
                        <span class="cta__shape-item cta__shape-item--1"><img :src="'/assets/images/cta/2.png'"
                                                                              alt="shape icon"></span>
                        <span class="cta__shape-item cta__shape-item--2"><img :src="'/assets/images/cta/4.png'"
                                                                              alt="shape icon"></span>
                        <span class="cta__shape-item cta__shape-item--3"><img :src="'/assets/images/cta/5.png'"
                                                                              alt="shape icon"></span>
                    </div>
                </div>
            </div>
